/*This is the class for the activity taking a tour on a bus
*/
...
public class BusRideTour implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface
{
	...
	public BusRideTour()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("BusRideTour constructor called");
		}
	}
