/** This is the class for the activity register for classes from a computer
*/
...
public class ComputerRegister implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface{
	...
	public ComputerRegister()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("ComputerRegister constructor called");
		}
	}
