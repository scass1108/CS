/** This is the class for the activity getting books at UniversityBookStore
*/
...
public class UniversityBookStore implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface
{
	...
	public UniversityBookStore()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("UniversityBookStore constructor called");
		}
	}
