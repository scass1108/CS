/** This is the class for the activity registering by forms
*/
...
public class FormRegister implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface{
	...
	public FormRegister()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("FormRegister constructor called");
		}
	}
