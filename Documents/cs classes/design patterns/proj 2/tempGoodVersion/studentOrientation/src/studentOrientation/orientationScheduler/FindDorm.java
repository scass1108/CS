/** This is the class for the activity finding a dorm by availability
*/
...
public class FindDorm implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface{
	...
	public FindDorm()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("FindDorm constructor called");
		}
	}
