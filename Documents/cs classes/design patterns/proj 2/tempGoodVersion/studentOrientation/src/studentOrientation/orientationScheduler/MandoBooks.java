/** This is the class for the activity buying books at MandoBooks
*/
...
public class MandoBooks implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface
{
	...
	public MandoBooks()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("MandoBooks constructor called");
		}
	}
