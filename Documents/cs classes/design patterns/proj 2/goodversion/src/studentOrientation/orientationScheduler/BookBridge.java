/** This is the class for the activity getting a book from BookBridge
*/
...
public class BookBridge implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface
{
	...
	public BookBridge()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("BookBridge constructor called");
		}
	}
