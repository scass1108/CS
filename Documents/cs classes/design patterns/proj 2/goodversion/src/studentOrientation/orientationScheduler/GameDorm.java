/** This is the class for the activity finding a dorm by playing a game
*/
...
public class GameDorm implements ActivityBuilder, EffortInterface, MoneyInterface, TimeInterface{
	...
	public GameDorm()
	{
		if(Debug.getDebug() == 2)
		{
			System.out.println("GameDorm constructor called");
		}
	}
